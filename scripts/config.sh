...
sed -i 's/CONFIG_TARGET_ROOTFS_PARTSIZE=512/CONFIG_TARGET_ROOTFS_PARTSIZE=1024/g' configs/rockchip/01-nanopi
#config2
...
echo 'CONFIG_PACKAGE_luci-app-unblockmusic=y' >> configs/rockchip/01-nanopi
