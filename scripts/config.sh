...
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Haproxy=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Hysteria=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_NaiveProxy=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Shadowsocks_Libev_Client=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Shadowsocks_Libev_Server=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Shadowsocks_Rust_Client=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_ShadowsocksR_Libev_Client=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Simple_Obfs=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Trojan_GO=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Trojan_Plus=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_V2ray=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_V2ray_Plugin=y' >> configs/rockchip/01-nanopi
echo 'CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Xray=y' >> configs/rockchip/01-nanopi
